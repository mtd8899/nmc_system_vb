...
Partial Public Class NewMalayan1Entities1
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=NewMalayan1Entities1")
    End Sub
    ...
    Public Overridable Property tblCollectionIns() As DbSet(Of tblCollectionIn)
    Public Overridable Property tblCollectionLoans() As DbSet(Of tblCollectionLoan)
    Public Overridable Property tblCollectionSavings() As DbSet(Of tblCollectionSaving)
    Public Overridable Property tblCollMiscs() As DbSet(Of tblCollMisc)
    Public Overridable Property tblCustomers() As DbSet(Of tblCustomer)
    Public Overridable Property tblInsurances() As DbSet(Of tblInsurance)
    Public Overridable Property tblLoanReleases() As DbSet(Of tblLoanRelease)
    Public Overridable Property tblSavingsAccs() As DbSet(Of tblSavingsAcc)
